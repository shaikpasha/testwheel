...
using testwheel.testwheel_XamlTypeInfo;
...
namespace testwheel.testwheel_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_MainPage() { return new testwheel.MainPage(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "testwheel.MainPage":
                userType = new XamlUserType(this, typeName, typeof(testwheel.MainPage), GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"));
